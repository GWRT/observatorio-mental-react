...
export default function FrontPage() {
  return (
    <div className='w-full h-screen bg-font-page bg-cover bg-center flex flex-col justify-center items-center'>
        <div className='max-w-[800px] p-5 space-y-5 filter backdrop-blur-[3px]'>
